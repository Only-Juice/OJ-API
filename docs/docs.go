...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/gitea/repos/{owner}/{repo}/dir/{filepath}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "/",
                        "description": "The path to the file or directory. Use empty string for root directory.",
                        "name": "filepath",
                        "in": "path"
                    },
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/gitea.ContentsResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/gitea/repos/{owner}/{repo}/file/{filepath}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/gitea.PublicKey"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.DeletePublicKey"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "gitea.ContentsResponse": {
            ...
            "properties": {
                "_links": {
                    "$ref": "#/definitions/gitea.FileLinksResponse"
                },
                "content": {
